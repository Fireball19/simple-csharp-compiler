...
public final class ACmpEqualsExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ACmpEqualsExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmpEqualsExpression(
    ...
    {
        ((Analysis) sw).caseACmpEqualsExpression(this);
    }
