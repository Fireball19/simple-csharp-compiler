...
public final class ACmpEqualsGreaterExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ACmpEqualsGreaterExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmpEqualsGreaterExpression(
    ...
    {
        ((Analysis) sw).caseACmpEqualsGreaterExpression(this);
    }
