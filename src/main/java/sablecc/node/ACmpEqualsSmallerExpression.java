...
public final class ACmpEqualsSmallerExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ACmpEqualsSmallerExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmpEqualsSmallerExpression(
    ...
    {
        ((Analysis) sw).caseACmpEqualsSmallerExpression(this);
    }
