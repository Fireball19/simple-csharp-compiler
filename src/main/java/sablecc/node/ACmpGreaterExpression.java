...
public final class ACmpGreaterExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ACmpGreaterExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmpGreaterExpression(
    ...
    {
        ((Analysis) sw).caseACmpGreaterExpression(this);
    }
