...
public final class ACmpNotEqualsExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ACmpNotEqualsExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmpNotEqualsExpression(
    ...
    {
        ((Analysis) sw).caseACmpNotEqualsExpression(this);
    }
