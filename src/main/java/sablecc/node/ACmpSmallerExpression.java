...
public final class ACmpSmallerExpression extends PExpression
{
    private PExpression _left_;
    private PExpression _right_;

    public ACmpSmallerExpression()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ACmpSmallerExpression(
    ...
    {
        ((Analysis) sw).caseACmpSmallerExpression(this);
    }
